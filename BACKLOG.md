...
- **T-79.4** `TODO` Package `einvoice/` as an embeddable, self-hostable product with an honest README + a CI conformance-gate recipe an ERP/billing vendor can drop in. deps: T-79.1. files: einvoice/README.md, einvoice/pyproject.toml (or bin), einvoice/ci/
