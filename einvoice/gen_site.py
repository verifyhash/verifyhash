...
def render_landing():
    ...
    description = ("A free, zero-dependency EN 16931 / XRechnung conformance "
                   "validator for German ERP and billing developers: 293 "
    ...
    w('<p class="lead">A zero-dependency, self-hostable conformance validator '
      ...
      "UN/CEFACT CII syntaxes). It asserts <strong>293 business rules</strong>, "
    ...
    w("<p>The engine asserts <strong>293 business rules</strong>: 215 of the "
    ...
    w("<p>The last admitted gap in the KoSIT XRechnung artifact — the "
      ...
      "Schematron. That worklist is now <strong>closed</strong>: 277 of the "
      "293 asserted rules are differential-proven on both UBL and CII, 12 are "
    ...
    w("<p>Beyond the business rules, the two CEN artifacts also carry "
      ...
      "exit code, kept strictly separate from the 293 business-rule count.</p>")
    w('<ul class="rules">')
    ...
    w('<li><a href="%s">Remediation catalog</a> — 293 machine-readable '
    ...
    w("<p>Der Pr&uuml;fer setzt <strong>293 Gesch&auml;ftsregeln</strong> "
    ...
    w("<p>Die letzte eingestandene L&uuml;cke im KoSIT-XRechnung-Artefakt — "
      ...
      "2026-07-23: 277 von 293 Regeln auf beiden Syntaxen bewiesen, 0 "
    ...
    w("<p>Ehrlicher Geltungsbereich: Ein gr&uuml;nes Ergebnis bedeutet "
      ...
      '<a href="%s">Korrektur-Katalog (remediation_catalog.json)</a> mit 293 '
...
def render_de():
    ...
    claim (293 rules, deferred BR-CL checks, no XSD validation, green != legal
    ...
    description = ("XRechnung und EN 16931 E-Rechnungen offline prüfen, "
                   ...
                   "CI-Anbindung und die ehrliche Abdeckung der 293 "
    ...
    w("<p>Ein Konformit&auml;tspr&uuml;fer f&uuml;r E-Rechnungen im Format "
      ...
      "setzt der Pr&uuml;fer <strong>293 Gesch&auml;ftsregeln</strong> durch; "
    ...
    w('<li><a href="../rules/index.html">Regel-Referenz</a> &mdash; jede der '
      "293 Regeln mit eigener Seite: Anforderung, BT-/BG-Begriffe, "
...
def render_walkthrough(catalog):
    ...
    w("<p>The engine behind this walkthrough asserts <strong>293 EN 16931 / "
      "XRechnung business rules</strong> — every official EN 16931 "
      "<code>BR-*</code> rule that can actually fire in either CEN syntax "
      "universe (UBL and CII) except four deferred code-list checks, the "
...
def render_de_walkthrough(catalog):
    ...
    w("<p>Die Engine hinter diesem Beispiel setzt <strong>293 "
      ...
      "CEN-Syntaxwelten (UBL und CII) au&szlig;er vier zur&uuml;ckgestellten "
