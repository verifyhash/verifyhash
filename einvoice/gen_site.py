...
def render_landing():
    ...
    description = ("A free, zero-dependency EN 16931 / XRechnung conformance "
                   "validator for German ERP and billing developers: 289 "
    ...
    w('<p class="lead">A zero-dependency, self-hostable conformance validator '
      ...
      "UN/CEFACT CII syntaxes). It asserts <strong>289 business rules</strong>, "
    ...
    w("<p>The engine asserts <strong>289 business rules</strong>: 211 of the "
    ...
    w("<p>The last admitted gap in the KoSIT XRechnung artifact — the "
      ...
      "289 asserted rules are differential-proven on both UBL and CII, 30 are "
    ...
    w("<p>Beyond the business rules, the two CEN artifacts also carry "
      ...
      "exit code, kept strictly separate from the 289 business-rule count.</p>")
    w('<ul class="rules">')
    ...
    w('<li><a href="%s">Remediation catalog</a> — 289 machine-readable '
    ...
    w("<p>Der Pr&uuml;fer setzt <strong>289 Gesch&auml;ftsregeln</strong> "
    ...
    w("<p>Die letzte eingestandene L&uuml;cke im KoSIT-XRechnung-Artefakt — "
      ...
      "2026-07-23: 255 von 289 Regeln auf beiden Syntaxen bewiesen, 0 "
    ...
    w("<p>Ehrlicher Geltungsbereich: Ein gr&uuml;nes Ergebnis bedeutet "
      ...
      '<a href="%s">Korrektur-Katalog (remediation_catalog.json)</a> mit 289 '
...
def render_de():
    ...
    claim (289 rules, deferred BR-CL checks, no XSD validation, green != legal
    ...
    description = ("XRechnung und EN 16931 E-Rechnungen offline prüfen, "
                   ...
                   "CI-Anbindung und die ehrliche Abdeckung der 289 "
    ...
    w("<p>Ein Konformit&auml;tspr&uuml;fer f&uuml;r E-Rechnungen im Format "
      ...
      "setzt der Pr&uuml;fer <strong>289 Gesch&auml;ftsregeln</strong> durch; "
    ...
    w('<li><a href="../rules/index.html">Regel-Referenz</a> &mdash; jede der '
      "289 Regeln mit eigener Seite: Anforderung, BT-/BG-Begriffe, "
...
def render_walkthrough(catalog):
    ...
    w("<p>The engine behind this walkthrough asserts <strong>289 EN 16931 / "
...
def render_de_walkthrough(catalog):
    ...
    w("<p>Die Engine hinter diesem Beispiel setzt <strong>289 "
