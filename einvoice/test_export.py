...
Checks (each an independent hard assert; mirrors the ACCEPTANCE CRITERIA):
  ...
  (c) HEADLINE PARITY — coverage.json's 288 / 741 / 756 / 554 / 583 headline
...
def main():
    ...
    if md is not None:
        ...
        check((md["business_rules"], md["ubl_proven"], md["ubl_total"],
               md["cii_proven"], md["cii_total"]) == (288, 741, 756, 554, 583),
              "COVERAGE.md headline is no longer 288 / 741 of 756 / 554 of 583 "
    ...
    print("export contract OK: %d rules, byte-reproducible, schemaVersion "
          "pinned, coverage headline == COVERAGE.md (288 / 741 of 756 UBL / "
