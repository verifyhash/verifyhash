...
def _render_syntax_binding(w):
    ...
    artifacts. These are NOT the business-rule matrix and NONE is evaluated
    ...
    w("- Honesty note: these are **NOT** part of the **%d business rules**"
      % len(engine_fireable_ids()))
